...
\033[1;33m
 ...
 ___  ___  _________  ________  ________  ___       ________      
|\  \|\  \|\___   ___\\   __  \|\   __  \|\  \     |\   ____\     
\ \  \\\  \|___ \  \_\ \  \|\  \ \  \|\  \ \  \    \ \  \___|_    
 \ \   __  \   \ \  \ \ \  \\\  \ \  \\\  \ \  \    \ \_____  \   
  \ \  \ \  \   \ \  \ \ \  \\\  \ \  \\\  \ \  \____\|____|\  \  
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install HTools.\033[1;m
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mHTools installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run HTools.
\033[1;33m    [ + ] \033[1;32mType HTools in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your HTools.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mHTools Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update HTools.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mHTools
\033[1;33m       [+] Author :- \033[1;32mHarsh Bakshi
\033[1;33m       [+] Latest Update :- \033[1;32m30/03/2020.\033[1;m
\033[1;33m       [+] Tools :- \033[1;32mtotal {total} tools.\033[1;m

\033[1;33m [+] \033[1;32mHTools is automatic tool installer.
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating HTools ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate HTools.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m         [ + ] \033[1;32mThanks for using HTools
